...
# Imports (utilities)
sys.path.append("./")
from utils.constants import RECV_FOLDER_PATH, PUBLIC_FOLDER_PATH, USER_SETTINGS_PATH
from utils.types import UserSettings

# Create application directories if they don't exist
app_dir = Path.home() / ".Echo"
    ...
    def __init__(self):
        ...
        try:
            ...
            self.user_settings: UserSettings = {
                "share_folder_path": str(PUBLIC_FOLDER_PATH),
            ...
            sys.path.append("./client/ui")
            from ui.EchoMainWindow import Ui_EchoMainWindow

            self.ui = Ui_EchoMainWindow(self)
